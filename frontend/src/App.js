...
import AdminWorkshopFeedback  from './admin/AdminWorkshopFeedback';
    ...
    <ErrorBoundary>
      <Router>
        <Routes>
          ...
          {/* ── Workshop Feedback (public, pre-login) ───────────────────────── */}
          ...
          <Route path="/earn"              element={<P><EarnPlatform /></P>} />
          ...
          <Route path="/admin-portal-9823/earn"       element={<A><AdminEarn /></A>} />
          <Route path="/admin-portal-9823/payments"    element={<A><AdminPayments /></A>} />
          <Route path="/admin-portal-9823/internships" element={<A><AdminInternships /></A>} />
          <Route path="/admin-portal-9823/projects"    element={<A><AdminProjects /></A>} />
          <Route path="/admin-portal-9823/workshop-feedback" element={<A><AdminWorkshopFeedback /></A>} />
          ...
          <Route path="/vtu-news"          element={<P><VTUNews /></P>} />
          ...
          <Route path="/internship-programs" element={<P><InternshipPrograms /></P>} />
          <Route path="/projects"          element={<P><ProjectsMarketplace /></P>} />
