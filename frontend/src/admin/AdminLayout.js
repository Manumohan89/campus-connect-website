...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Internships',  path: '/admin-portal-9823/internships', icon: <SchoolIcon />,      color: '#7C3AED', badge: null },
      { label: 'Projects',     path: '/admin-portal-9823/projects',    icon: <CodeIcon />,        color: '#0EA5E9', badge: null },
      { label: 'Workshop Feedback', path: '/admin-portal-9823/workshop-feedback', icon: <ForumIcon />, color: '#a855f7', badge: null },
      ...
      { label: 'Earn Platform', path: '/admin-portal-9823/earn',        icon: <PaymentIcon />,     color: '#7C3AED', badge: null },
    ]
  },
  {
    group: 'Communication',
