              ...
              <Table size="small">
                ...
                <TableBody>
                  {users.map(u => {
                    ...
                    return (
                      <TableRow key={u.user_id} sx={{ '&:hover': { bgcolor: '#F8FAFC' }, opacity: u.is_blocked ? 0.6 : 1 }}>
                        <TableCell sx={{ py: 1.5 }}>
                          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
                            <Avatar sx={{ width: 32, height: 32, bgcolor: color, fontSize: '0.75rem', fontWeight: 800 }}>{initials(u.full_name)}</Avatar>
                            <Box>
                              <Typography sx={{ fontWeight: 700, fontSize: '0.85rem', color: '#111827' }}>{u.full_name || u.username}</Typography>
              ...
              <Grid container spacing={2} sx={{ mb: 3 }}>
                {[
                  ...
                  <Grid item xs={6} sm={3} key={label}>
                    ...
                    <Typography sx={{ fontWeight: 700, fontSize: '0.875rem', color: '#111827' }}>{val}</Typography>
                  </Grid>
                ))}
              </Grid>
