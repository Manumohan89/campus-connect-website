          ...
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
            ...
            <Box sx={{ display: 'flex', gap: 2, alignItems: 'flex-start' }}>
              ...
              <Box>
                ...
                <Typography sx={{ fontWeight: 800, fontSize: '0.95rem', color: '#111827', lineHeight: 1.3 }}>{exam.subject_name}</Typography>
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', bgcolor: '#F5F3FF' }}>
      ...
      <Container sx={{ py: 5 }}>
        ...
        {upcoming.length > 0 ? (
          <>
            <Typography sx={{ fontWeight: 800, fontSize: '1rem', color: '#111827', mb: 2 }}>Upcoming Exams</Typography>
