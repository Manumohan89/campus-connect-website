...
import {
  Container, Box, Card, Typography, Button, Alert,
  Stack, Paper, LinearProgress, Snackbar, Divider, Chip
} from '@mui/material';
...
export default function ShareDocuments() {
  ...
  const handleUpload = async () => {
    ...
    try {
      await api.post('/users/share-document', fd, { headers: { 'Content-Type': 'multipart/form-data' } });
      setSuccess(true);
