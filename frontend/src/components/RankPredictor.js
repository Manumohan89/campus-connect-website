      ...
      <Container sx={{ py: 5 }}>
        ...
        {!hasData ? (
          <Paper elevation={0} sx={{ border: '2px dashed #FDE68A', borderRadius: '20px', p: 8, textAlign: 'center', bgcolor: 'white' }}>
            ...
            <Typography sx={{ fontWeight: 800, fontSize: '1.2rem', color: 'var(--text-1,#111827)', mb: 1 }}>Upload your marks first</Typography>
          ...
          <>
            ...
            <Paper elevation={0} sx={{ border: '1px solid #E5E7EB', borderRadius: '20px', overflow: 'hidden', bgcolor: 'white' }}>
              <Box sx={{ px: 4, py: 3, borderBottom: '1px solid #F3F4F6' }}>
                <Typography sx={{ fontWeight: 800, fontSize: '1rem', color: 'var(--text-1,#111827)' }}>VTU CGPA Distribution Reference</Typography>
