    ...
    <Box sx={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', bgcolor: '#F8FAFC' }}>
      ...
      <Container sx={{ py: 4 }} maxWidth="md">
        ...
        <Card elevation={0} sx={{ border: '1px solid #E5E7EB', borderRadius: '20px', p: 3, mb: 3 }}>
          <Typography sx={{ fontWeight: 800, fontSize: '1rem', color: '#111827', mb: 0.5 }}>Avatar Color</Typography>
        ...
        {/* Theme selection */}
        <Card elevation={0} sx={{ border: '1px solid #E5E7EB', borderRadius: '20px', p: 3, mb: 3 }}>
          <Typography sx={{ fontWeight: 800, fontSize: '1rem', color: '#111827', mb: 0.5 }}>Color Theme</Typography>
