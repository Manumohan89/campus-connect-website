...
import {
  ...
  Chip, IconButton, Divider, Snackbar, Paper, Tabs, Tab,
  FormControl, InputLabel, Select, MenuItem, Alert, CircularProgress} from '@mui/material';
...
@media print {
  ...
  #rv, #rv * { visibility: visible !important; }
  #rv { position: fixed !important; top: 0; left: 0; width: 210mm; background: white !important; padding: 12mm 14mm !important; }
          ...
          <Grid item xs={12} lg={7}>
            <Box sx={{ position: 'sticky', top: 72 }}>
              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
                <Typography sx={{ fontWeight: 800, color: '#111827', fontSize: '0.95rem' }}>Live Preview</Typography>
