        ...
        <Grid container spacing={4}>
              ...
              {[
                ...
                <Card key={i} elevation={0} sx={{ border: '1px solid #E5E7EB', borderRadius: '14px', p: 2.5 }}>
                  <Box sx={{ display: 'flex', gap: 1.5 }}>
                    ...
                    <Box>
                      <Typography sx={{ fontWeight: 700, fontSize: '0.85rem', color: '#111827' }}>{info.title}</Typography>
          ...
          <Grid item xs={12} md={8}>
            <Card elevation={0} sx={{ border: '1px solid #E5E7EB', borderRadius: '20px', p: { xs: 3, md: 4 } }}>
              <Typography sx={{ fontWeight: 800, fontSize: '1.2rem', color: '#111827', mb: 0.5, fontFamily: "'Space Grotesk', sans-serif" }}>Send a Message</Typography>
