...
import {
  Box, Container, Typography, Card, TextField, Button, Chip, Avatar, Select, MenuItem, FormControl, InputLabel, Alert
} from '@mui/material';
...
// Socket.io must connect to the BACKEND (Render), not the frontend origin (Vercel).
// In dev, window.location.origin proxies to localhost:5000 — works fine.
// In prod, REACT_APP_API_URL = https://...onrender.com/api, strip /api for socket root.
const SOCKET_URL = (() => {
