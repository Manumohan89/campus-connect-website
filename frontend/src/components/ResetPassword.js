...
import { LockReset, CheckCircle, Visibility, VisibilityOff, IconButton, InputAdornment } from '@mui/icons-material';
import { IconButton as MuiIconButton, InputAdornment as MuiInputAdornment } from '@mui/material';
            ...
            <>
              ...
              <form onSubmit={handleSubmit}>
                <TextField fullWidth label="New Password" type={show ? 'text' : 'password'} value={password}
                  ...
                  InputProps={{ endAdornment: <MuiInputAdornment position="end"><MuiIconButton onClick={() => setShow(s => !s)} edge="end">{show ? <VisibilityOff /> : <Visibility />}</MuiIconButton></MuiInputAdornment> }}
