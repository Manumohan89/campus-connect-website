...
const createUser = async (userData) => {
    ...
    return pool.query(
      `INSERT INTO users (username, email, password, full_name, semester, college, mobile, branch, year_scheme)
       VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9) RETURNING *`,
      [username, email, password, fullName, semester, college, mobile, branch, yearScheme]
    );
  };
