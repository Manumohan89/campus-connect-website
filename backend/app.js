...
const runMigrations = async () => {
  const pool = require('./db');
  for (const file of ['init.sql','run_migration.sql','migration_v2.sql','migration_v3.sql','earn_migration.sql','admin_migration.sql','workshop_feedback_migration.sql','remove_otp_migration.sql']) {
