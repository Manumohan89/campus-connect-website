...
const runMigrations = async () => {
  const pool = require('./db');
  for (const file of ['rename_current_role_migration.sql','init.sql','run_migration.sql','migration_v2.sql','migration_v3.sql','earn_migration.sql','admin_migration.sql','workshop_feedback_migration.sql','remove_otp_migration.sql','fix_constraints_migration.sql','enrollments_constraint_migration.sql','user_solved_problems_constraint_migration.sql','certificate_review_status_migration.sql']) {
